...
// 👑 OWNER COMMANDS (With Specific Reactions)
	...
	case "remini", "removebg":
		react(client, v, "⏳")
		replyMessage(client, v, "⚠️ *Premium Feature:*\nThis feature requires a dedicated API Key. It will be unlocked in the next update by HINA x SAHIBZADA!")
		...
		ExtendedTextMessage: &waProto.ExtendedTextMessage{
			...
			ContextInfo: &waProto.ContextInfo{
				...
				QuotedMessage: &waProto.Message{
					Conversation: proto.String("💫 "💫 𝗛𝗜𝗡𝗔 ❤️ x 🔥 𝗦𝗔𝗛𝗜𝗕𝗭𝗔𝗗𝗔 💫 Official Bot ✅"),
				},
			},
		},
	})
...
func handleSendButtons(client *whatsmeow.Client, v *events.Message) {
	...
	interactiveMsg := &waE2E.InteractiveMessage{
		...
		Footer: &waE2E.InteractiveMessage_Footer{
			Text: proto.String("HINA x SAHIBZADA Official! ❤️🔥!"),
		},
